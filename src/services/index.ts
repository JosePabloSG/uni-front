export * from "./NivelAcademico/commads/createNivelAcademico";
export * from "./NivelAcademico/commads/deleteNivelAcademico";
...
export * from "./ProgramaAcademico/commands/deleteProgramaAcademico";
export * from "./ProgramaAcademico/commands/updateProgramaAcademico";
export * from "./ProgramaAcademico/queries/getAllProgramaAcademico";

export * from "./Inscripcion/commads/createInscripcion";
